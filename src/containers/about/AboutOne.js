...
import "./About.css"
//https://www.sivadass.in/welcome-to-my-blog/
        ...
        return (
            <div className="about-div">
                <div className="container" style={{ minHeight: '750px' }}>
                    <section className="animated animatedFadeInUp fadeInUp">
                        <div className='headshot ' id='animate-img'>
                            <img src="assets/sharan.jpeg" alt='sharanagouda' className="about-profile-pic" />
                        </div>
                    </section>
                    <br />
                    <section className="animated1 animatedFadeInUp fadeInUp">
                        <div className="columns">
                            <div className="column info">
                                <p className='hey-content'>Hey there!</p>
                                <p className="about-content">My name is Sharanagouda K and I'm a front end web developer. I build responsive websites using modern technologies like React, Angular, Git, as well as good old jQuery. I also have experience with Ionic framework.<br /><br />This blog contains my best answers to questions that UI developers struggle with.<br />
